      ...
      >
        ...
        >
          ...
          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-center md:justify-start gap-3 sm:gap-x-5">
            <Link
              href="/projects"
              className="rounded-md bg-transform px-4 py-2 text-sm font-semibold black:text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
            >
